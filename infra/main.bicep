...
resource postgresSQLServer 'Microsoft.DBforPostgreSQL/flexibleServers@2022-12-01' = {
  ...
  properties: {
    administratorLogin: 'appServiceAPIDBHostDBUSER'// Exercise II: dmakjd Use a parameter to pass the value for this attribute via GITHUB secret with name 'DBUSER'
