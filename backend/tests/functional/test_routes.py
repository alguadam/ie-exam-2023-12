...
def test_dummy_wrong_path():
    ...
    """
    #DONE Exercise 1: Develop this test according to the definition and make it pass in the GitHub workflow
...
def test_create_character(testing_client):
    ...
    response = testing_client.post('/characters', json={'alias': 'Grets1', 'name': 'Greta'})
    assert response.status_code == 200
